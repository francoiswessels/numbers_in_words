...
class TestValueMapComplete(ut.TestCase):
    def test_map_members_complete(self):
        ...
        mapped_keys = niw._map_to_words.keys()
...
class TestProvidedTestCases(ut.TestCase):
    def setUp(self):
        self.full_scenarios: List[Scenario] = [
            Scenario("The pump is 536 deep underground.", "five hundred and thirty-six"),
            Scenario("We processed 9121 records.", "nine thousand, one hundred and twenty-one"),
            Scenario("Variables reported as having a number invalid missing type #65678.", "number invalid"),
            Scenario("Interactive and printable 10022 ZIP code.", "ten thousand and twenty-two"),
            Scenario("The database has 66723107008 records.", "sixty-six billion, seven hundred and twenty-three million, one hundred and seven thousand and eight"),
            Scenario("I received 23 456,9 KGs.", "number invalid")]
